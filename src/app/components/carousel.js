      ...
      <div style={{ width: '80%' }} className="mx-auto">
        ...
        >
          <SwiperSlide className="flex justify-center">
            <Image src={img1} alt={alt1} width={1000} height={300} className="w-full flex justify-center h-auto object-cover rounded-lg shadow-lg"/>
          </SwiperSlide>
          <SwiperSlide className="flex justify-center">
            <Image src={img2} alt={alt2} width={1000} height={300} className="w-full flex justify-center h-auto object-cover rounded-lg shadow-lg"/>
          </SwiperSlide>
          <SwiperSlide className="flex justify-center">
            <Image src={img3} alt={alt3} width={1000} height={300} className="w-full flex justify-center h-auto object-cover rounded-lg shadow-lg"/>
          </SwiperSlide>
        </Swiper>
