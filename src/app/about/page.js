  ...
  return (
    <RootLayout> {/* everything inside of layout is part of props.children*/}
        <div className="w-full overflow-auto">
          {/* About Section */}
          <section id="aboutsect" className="py-12 px-6 flex bg-gray-100">
            <div className="w-full">
              <h4 className="text-2xl font-bold text-gray-800 flex justify-center gap-2">
                <span role="img" aria-label="Girl emoji">👩🏻</span> About Us
              </h4>
              <div className="flex flex-col md:flex-row items-center gap-8 mt-6">
                <Image src={img1} alt="Sample Summer Top Crochet Kit Contents" className="w-1/2 h-1/2 md:w-1/3 rounded-lg shadow-lg"/>
                <div className="flex-2 text-gray-700 space-y-4">
                ...
                <Image src={img2} alt="Sample Scrunchie Crochet Kit Complete" className="w-1/2 h-1/2 md:w-1/3 rounded-lg shadow-lg"/>
              </div>
            </div>
          </section>
